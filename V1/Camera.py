...
class Cam():
    ...
    def worker(self):
        ...
        cur_dir = "/home/IDMind/Documents/V1/videos/other"
        
        while(self.run):
            time.sleep(0.02)
            
            if not self.commands.tracking_enabled:
                
                if self.webapp.SessionID != "-1":
                    new_dir = f"/home/IDMind/Documents/V1/videos/{self.webapp.SessionID}"
                else:
                    new_dir = f"/home/IDMind/Documents/V1/videos/other"
...
if __name__ == "__main__":
    clip_video(input_file = "/home/IDMind/Documents/V1/videos/014643.mp4", output_file="/home/IDMind/Documents/V1/videos/012741_crop.mp4", start_time=742, stop_time=805)
    #main({"stop":False})
